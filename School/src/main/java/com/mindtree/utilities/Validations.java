...
/*
 * public static Connection Connectivity() throws SQLException { Connection con
 * = null; con = (Connection) DriverManager.getConnection(url, user_Name,
 * password); System.out.println("database it connected");
 * 
 * return con;
 * 
 * }
